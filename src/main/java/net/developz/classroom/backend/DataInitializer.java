...
// import net.developz.classroom.backend.catalog.schedule.Day;
// import net.developz.classroom.backend.catalog.schedule.Period;
// import net.developz.classroom.backend.catalog.schedule.infrastructure.persistence.repository.DayRepository;
...
// import net.developz.classroom.backend.catalog.schedule.infrastructure.persistence.repository.PeriodRepository;
...
// import net.developz.classroom.backend.iam.user.infrastructure.persistence.entity.PersonRole;
...
public class DataInitializer {
    ...
    // log.info("Root Administrator created successfully with default password
    // 'Admin123!'");
    // } else {
    // log.warn("Could not seed Root Administrator because 'ADMIN' role was not
    // found.");
    // }
    // }
    // }
    ...
    // "GROUP_DELETE",
    // // Operations
    // "ENROLLMENT_VIEW", "ENROLLMENT_CREATE", "ENROLLMENT_UPDATE",
    // "ENROLLMENT_DELETE",
    ...
    // java.util.Map.of("en", "Mathematics I", "es", "MatemÃƒÂ¡ticas I"));
    // Subject phys = createSubject("PHYS-01", 1,
    // java.util.Map.of("en", "Physics I", "es", "FÃƒÂ­sica I"));
    // Subject prog = createSubject("PROG-01", 1,
    // java.util.Map.of("en", "Programming Fundamentals", "es", "Fundamentos de
    // ProgramaciÃƒÂ³n"));
    // Subject math2 = createSubject("MATH-02", 2,
    // java.util.Map.of("en", "Mathematics II", "es", "MatemÃƒÂ¡ticas II"));
    ...
    // private Subject createSubject(String code, Integer level,
