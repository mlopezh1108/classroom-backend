...
import net.developz.classroom.backend.catalog.exam.domain.model.BooleanQuestion;
import net.developz.classroom.backend.catalog.exam.domain.model.MultipleChoiceQuestion;
...
class AddQuestionUseCaseTest {
    ...
    void shouldAddBooleanQuestion() {
        ...
        CreateQuestionRequest request = new CreateQuestionRequest(examId, "Is Java fun?", 1, 10.0, QuestionType.BOOLEAN,
                true, null, null);
        Exam exam = new Exam();
    ...
    void shouldAddMultipleChoiceQuestion() {
        ...
        CreateQuestionRequest request = new CreateQuestionRequest(examId, "Pick one", 1, 10.0,
                QuestionType.MULTIPLE_CHOICE, null, options, null);
        Exam exam = new Exam();
